                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div>
                            ...
                            <x-select2 class="mt-1" id="country" name="country" :options="$this->listsForFields['users']"
                        ...
                        <div class="mt-4">
                            ...
                            <input x-data x-init="new Pikaday({ field: $el, format: 'MM/DD/YYYY' })" type="text" id="order_date"
                                wire:model.lazy="order.order_date" autocomplete="off"
                        ...
                        <table class="mt-4 min-w-full border divide-y divide-gray-200">
                            <thead>
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span
                                        class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">Product</span>
                                </th>
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span
                                        class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">Quantity</span>
                                </th>
